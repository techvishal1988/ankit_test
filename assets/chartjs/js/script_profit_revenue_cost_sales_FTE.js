...
function exportCsv(data) {
	...
	XLSX.writeFile(wb, "compben_dashboard_profit_revenue_cost_sales.xlsx");
}
...
//		},
	...
	exportToPDFBtn.click(function () {
		...
		Highcharts.exportCharts(allChartsOnThePageAsHighCharts, {
			filename : 'compben_charts_profit_revenue_cost_sales',
		...
		setTimeout(function() {
		  ...
		  domtoimage.toPng(node[0])
			...
			if(i == chartArray.length) {
			    pptx.save('compben_charts_profit_revenue_cost_sales');
			    $('#loading').hide()
			}
