...
<div class="col-sm-4">
    <ol class="breadcrumb ">
        ...
        <li><a href="<?php echo base_url("salary-rule-list/".$this->uri->segment(2)); ?>">Salary Rules</a></li>
        <li class="active">Employee not in salary rule         </li> 
    </ol>
    </div>
    <?php
    ...
    <div class="col-sm-8 text-right">
        ...
        <?php }else{?>
            ...
            <a href="<?php echo base_url('admin/admin_dashboard/empexport/'.$performance_cycle_id) ?>"  class="btn btn-success">Download Data</a>
        <?php }?>
    </div>
                <?php } ?>
   </div>
...
<style type="text/css">
    ...
    .ui-autocomplete {         
       ...
       .table-scroll thead tr { position: sticky !important;}
...
<div class="row mb20">
  ...
  <?php createDataTable(
                        ...
                        $ajaxurl=base_url('admin/admin_dashboard/ajax_emp_not_in_rule_list/'.$performance_cycle_id),
                        $href=[
                                [
                                    "javascript"=>'',
