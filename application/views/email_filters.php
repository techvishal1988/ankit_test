...
?>
  <div class="salary_rt_ftr">
   <div class="form_head clearfix" style="margin-top: 10px;">
      <div class="col-sm-12">
         
        <ul>
          <li>
            <div class="form_tittle">
              <h4>Send Mail By Selecting Individual User. </h4>
            </div>
          </li>
          <li>
            <div class="form_info">
        ...
        <div class="row form_sec clearfix">
          <div class="col-md-12">
       <div class="col-sm-12">
        <div class="form-group my-form attireBlock">
           <label class="col-sm-12 col-md-4 col-lg-4 col-xs-12 control-label removed_padding" style="line-height: 29px;">&nbsp;&nbsp;&nbsp;Users List</label>
           <div class="col-sm-12 col-md-8 col-lg-8 col-xs-12 removed_padding">
               
            <div class="">
               <select id="users"  name="users[]"  class="form-control multipleSelect" required="required" multiple="multiple" onchange="get_value();" >
               <!--  <option  value="all">All</option> -->
                   <?php
                      foreach ($employee_list as $value) {
                           ?>
                <option  value="<?php echo $value['email']; ?>" ><?php echo $value['name']; ?></option> 
                           <?php
                          }    
                   ?>  
                </select>
    ...
    <div class="form_head clearfix">
      <div class="col-sm-12">
        ...
        <ul>
          <li>
            <div class="form_tittle">
              <h4>Select Target Population To Sent Introduction Mail</h4>
            </div>
          </li>
          <li>
            <div class="form_info">
  ...
  <form class="form-horizontal mob_no_lbl_bg frm_cstm_popup_cls_default" method="post" action="<?php echo base_url('upload/SetEmailIntoQueue'); ?>" onsubmit="return request_custom_confirm('frm_cstm_popup_cls_default')">
      <?php echo HLP_get_crsf_field();?>
  <input type="hidden" name="upload_id" value="<?php echo $ruleid; ?>">
            <div class="row">
                <div class="col-sm-6">
                  <div class="form-group my-form attireBlock">
           <label class="col-sm-12 col-md-4 col-lg-4 col-xs-12 control-label removed_padding">Hierarchy Level</label>
           <div class="col-sm-12 col-md-8 col-lg-8 col-xs-12 removed_padding">
               
            <div class="">
              <?php //echo $rule_dtls['managers']; ?>
             <select id="survey_for"  name="survey_for[]"  class="form-control multipleSelect"  multiple="multiple" onchange="hide_list('survey_for')" >
                 <?php
                       
                 ?>  
                 <option  value="manager" <?php echo $manager ?>  <?php echo $select_all; ?> >Managers</option>
                   <option  value="employee" <?php echo $employee ?>  <?php echo $select_all; ?> >Individual Contributor</option> 
                   <option  value="approver_1" <?php echo $employee ?>  <?php echo $select_all; ?> >Approver 1</option> 
                   <option  value="approver_2" <?php echo $employee ?>  <?php echo $select_all; ?> >Approver 2</option> 
                   <option  value="approver_3" <?php echo $employee ?>  <?php echo $select_all; ?> >Approver 3</option> 
                   <option  value="approver_4" <?php echo $employee ?>  <?php echo $select_all; ?> >Approver 4</option> 
                </select>
              </div>
           </div>  
        </div>
                    ...
                    if(isset($sub_subfunction_list)){ ?>
                        <div class="form-group my-form attireBlock">
                           ...
                           <div class="col-sm-8 col-xs-12 removed_padding">
                            <div class="">
                               <select id="ddl_sub_subfunction" name="ddl_sub_subfunction[]" onchange="hide_list('ddl_sub_subfunction');" class="multipleSelect"  multiple="multiple">
                                    <option  value="all">All</option>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group my-form attireBlock label_type"  >
      ...
      <div class="col-sm-12">
        ...
        <ul>
          <li>
            <div class="form_tittle">
              <h4>Email template which will be send . </h4>
            </div>
          </li>
          <li>
            <div class="form_info">
...
<script>
function get_value (argument) {
var user_list = $('#users option:selected').toArray().map(item => item.value).join();
$('#user_list').val(user_list);
