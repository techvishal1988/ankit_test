            ...
            <div class="col-md-4 left-md">
                <div class="leftTeamArea whiteBlock">
                    <?php /*?><?php if($is_enable_approve_btn == 1 and $this->session->userdata('is_manager_ses') == 1 and isset($is_open_frm_manager_side)){?>
                                    <a style="    position: absolute;  margin-left: 46%;  margin-top: 13px;" href="<?php echo site_url("manager/send-lti-for-next-level/".$rule_id); ?>" onclick="return confirm('Are you sure, You want?')">
                                    ...
                                    <tr>
                                        <td>
											<?php if($this->session->userdata('is_manager_ses') == 1 and isset($is_open_frm_manager_side))
                                                { ?>
                                           			<a href="<?php echo site_url("manager/view-employee-lti-dtls-released/".$row["rule_id"]."/".$row["id"]); ?>"><?php echo $row["name"]; ?></a>
                                            <?php } else { ?>
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="row">
                                             <div class="col-md-12">
                                                 <h2>
                                                    ...
                                                    <?php /*?>  <?php if($rule_dtls["lti_basis_on"]!=2){ ?>
                                                 <span style="    color: gray;font-size: 13px;">
                                                 <?php echo $emp_lti_dtls["grant_value"]; ?>% Of Base Salary</span>
                                                 <?php } ?><?php */?>
                                                </h2>
                                             ...
                                             <div class="col-sm-12">
                                                 <h2 style="background-color: #eee;padding: 8px 12px;width: 100%; margin-bottom: 3px;">
                                                     <?php if($rule_dtls["lti_basis_on"]!=2){ ?>
                                                 <span style="max-width: 300px !important; background-color: #eee;font-size: 15px; color: #555;">
                                                 <?php echo $emp_lti_dtls["grant_value"]; ?>% Of Base Salary</span>
                                                 <?php } ?>
                                                 </h2>
                                             </div>
                                        ...
                                        <?php if($this->session->userdata('is_manager_ses') == 1 && $emp_lti_dtls["rule_status"]==6 && strtolower($emp_lti_dtls["manager_emailid"]) == strtolower($this->session->userdata('email_ses')) and isset($is_open_frm_manager_side)){?>
                                            <div class="col-md-1">
                                                <?php /*?><button style="margin-left:30px;" type="submit" class="btn btn-primary" onclick="return confirm('Are you sure ?');">Recommend</button><?php */?>                                               
                                            </div>
                                        <?php } ?>
