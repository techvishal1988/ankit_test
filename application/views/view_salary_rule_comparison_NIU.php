        ...
        <div class="col-md-12 col-xs-12 background-cls">
            <div class="mailbox-content" style="overflow-x:auto">
				...
				foreach($rule_list as $row)
				{
					...
					$rule_comparison_dtls = json_decode($row["rule_comparison_dtls"], true);
					$total_emps .= "<td>".$rule_comparison_dtls["total_emps"]."</td>";
					$total_managers .= "<td>".$rule_comparison_dtls["total_managers"]."</td>";
					$total_budget .= "<td><a href=".site_url("view-salary-rule-details/".$row["id"]).">".$row["currency_name"]." ".HLP_get_formated_amount_common($rule_comparison_dtls["total_rule_budget"])."</a></td>";
					$total_current_salary .= "<td><a href=".site_url("view-salary-rule-details/".$row["id"]).">".$row["currency_name"]." ".HLP_get_formated_amount_common($rule_comparison_dtls["total_current_salary"])."</a></td>";
					$total_budget_to_cr1 .= "<td><a href=".site_url("view-salary-rule-details/".$row["id"]).">".$row["currency_name"]." ".HLP_get_formated_amount_common($rule_comparison_dtls["total_budget_to_cr1"])."</a></td>";
					$avg_of_total_pre_cr .= "<td><a href=".site_url("view-salary-rule-details/".$row["id"]).">".HLP_get_formated_percentage_common($rule_comparison_dtls["avg_of_total_pre_cr"])."%</a></td>";
					$avg_of_total_post_cr .= "<td><a href=".site_url("view-salary-rule-details/".$row["id"]).">".HLP_get_formated_percentage_common($rule_comparison_dtls["avg_of_total_post_cr"])."%</a></td>";
					$avg_of_total_improvment_on_cr .= "<td><a href=".site_url("view-salary-rule-details/".$row["id"]).">".HLP_get_formated_percentage_common($rule_comparison_dtls["avg_of_total_improvment_on_cr"])."%</a></td>";
				...
				<div class="table-responsive" id="dvContents">
                    <table border="1" cellspacing="0" class="table border" style="width:100%;  overflow:scroll !important;">
                        ...
                        <tbody id="tbl_body">
							...
							echo "<tr><th>Total Employees</th>". $total_emps ."</tr>";
							echo "<tr><th>Total Budget </th>". $total_budget ."</tr>";
