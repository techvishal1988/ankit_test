    ...
    <div class="row">
       <div class="col-sm-8">
        <ol class="breadcrumb">
            ...
            <li class="active"><?php if(!empty($report_type) && $report_type == 'turnover') { echo 'Turnover Report'; } else { echo 'Head Count Report'; } ?></li>
        </ol>
       </div>
...
<div class="container-fluid compp_fluid">
    <div class="text-center mt-4">
        ...
        ?>
        <h3 class="text20 textbold" style="margin-bottom:-8px;"><?php if(!empty($report_type) && $report_type == 'turnover') { echo 'Turnover Report'; } else { echo 'Head Count Report'; } ?><strong class="total-emp"></strong>
            <!-- <span style=" float: none;" type="button" class="tooltipcls" data-toggle="tooltip control-label" data-placement="bottom" title="" data-original-title="<?php //echo $val[0] ?>"><i class="fa fa-info-circle themeclr" aria-hidden="true"></i></span> --></h3>
    </div>
...
<script>
<?php
if(!empty($report_type) && $report_type == 'turnover') { ?>
    var GRAPHAPIURL="<?php echo base_url('api/graph/report/0/1') ?>";
    var titlePrefix = 'Turnover by ';
<?php } else { ?>
    var GRAPHAPIURL="<?php echo base_url('api/graph/report/1/1') ?>";
    var titlePrefix = 'HC By ';
<?php  } ?>
var dataKeys = {
...
?>
<script src="<?php echo base_url('assets/chartjs') ?>/js/script.js"></script>
<script>
