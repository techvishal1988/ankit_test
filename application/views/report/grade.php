...
<body>
    <div id="grade" style="position: absolute; margin-top: -52px"></div>
...
var dataset = [
	<?php $str='';
	for($i=0;$i<count($res['Grade']);$i++) { ?>
	{label:"<?php echo $res['Grade'][$i]['Grade'] ?>", "Minimum":<?php echo $res['Grade'][$i]['Minimum'] ?>, "Maximum":<?php echo $res['Grade'][$i]['Maximum'] ?>, "Average": <?php echo $res['Grade'][$i]['avg'] ?>},
	<?php } ?>
