...
<div class="page-breadcrumb">
    <ol class="breadcrumb container">
        ...
        <li class="active">Head Count Report </li>
    </ol>
</div>
<div class="page-title">
    <div class="container">
        <div class="text-center mt-4">
            <h3 id="dashboardTitle" style="margin-bottom:10px">Head Count Report
					<span style=" float: none;" type="button"
            class="tooltipcls" data-toggle="tooltip control-label" data-placement="bottom" title="" data-original-title="">
						<i
...
<script src="
				<?php echo base_url('assets/chartjs') ?>/js/headcount.js">
</script>
...
<script>
    $(document).ready(function() {
        ...
        initialize(nodejs_api_helper.base_url + '/headcount', nodejs_api_helper, allChartsOnThePage, filterDiv, exportToPDFBtn, exportToExcelBtn); //for default year -- currently one
