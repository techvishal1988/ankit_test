...
var dataset = [
	...
	{label:"<?php echo $res['Grade'][$i]['label'] ?>", "Minimum":<?php echo $res['Grade'][$i]['allocated_budget'] ?>, "Maximum":<?php echo $res['Grade'][$i]['actual_used_budget'] ?>, "Average": <?php echo $res['Grade'][$i]['variance'] ?>},
	<?php } ?>
