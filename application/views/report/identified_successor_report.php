    ...
    <div class="row">
       <div class="col-sm-8">
        <ol class="breadcrumb">
            ...
            <li class="active">Identified Successor's Report</li>
        </ol>
       </div>
...
<div class="container-fluid compp_fluid">
    <div class="text-center mt-4">
        ...
        ?>
        <h3 class="text20 textbold" style="margin-bottom:-8px">Identified Successor's Report<strong class="total-emp"></strong>
    </div>
...
var GRAPHAPIURL = "<?php echo base_url('/api/graph/report/1/1/identified') ?>";
var titlePrefix = "Identified Successor's Distribution by  ";
var dataKeys = {
    ...
    "successorIdentified": "<?php  echo !empty($datakey_array['successor_identified']) ? $datakey_array['successor_identified'] : 'successor_identified' ?>",
...
var displayName = {
    ...
    "successorIdentified": "<?php  echo !empty($display_field_name_array['successor_identified']) ? $display_field_name_array['successor_identified'] : 'Successor Identified' ?>",
...
?>
<script src="<?php echo base_url('assets/chartjs') ?>/js/identified_successor_report.js"></script>
<script>
