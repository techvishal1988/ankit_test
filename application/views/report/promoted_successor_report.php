    ...
    <div class="row">
       <div class="col-sm-8">
        <ol class="breadcrumb">
            ...
            <li class="active">Successor's Who Got Promoted</li>
        </ol>
       </div>
...
<div class="container-fluid compp_fluid">
    <div class="text-center mt-4">
        ...
        ?>
        <h3 class="text20 textbold" style="margin-bottom:-8px">Successor's Who Got Promoted<strong class="total-emp"></strong>
    </div>
...
var GRAPHAPIURL = "<?php echo base_url('api/graph/promotedSuccessorReportData/1/1') ?>";
var titlePrefix = "Successor's Got Promoted by  ";
var dataKeys = {
    ...
    "promotedIn2yrs": "<?php  echo !empty($datakey_array['promoted_in_2_yrs']) ? $datakey_array['promoted_in_2_yrs'] : 'promoted_in_2_yrs' ?>",
...
?>
<script src="<?php echo base_url('assets/chartjs') ?>/js/promoted_successor_report.js"></script>
<script>
