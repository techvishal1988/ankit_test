	 ...
	 <div class="container-fluid compp_fluid">	
	   <div class="row">
		  ...
		  <ol class="breadcrumb ">
			...
			<li class="active">Revenue and Profit per FTE vs Avg FTE Cost - Sales</li>
		  </ol>
	    </div>
       </div>
      </div>
	...
	<div class="page-title">
		 <div class="container-fluid compp_fluid">
			<div class="text-center mt-4">
				<h3 class="textbold text20" id="dashboardTitle" style="margin-bottom:-8px">Revenue and Profit per FTE vs Avg FTE Cost - Sales 
					<!-- <span style=" float: none;" type="button"class="tooltipcls" data-toggle="tooltip control-label" data-placement="bottom" title="" data-original-title=""><i class="fa fa-info-circle themeclr" aria-hidden="true"></i></span> -->
                <div style="display: inline-block;">
					<form class="form-inline" style=" margin-bottom: 8px;">
						<div class="form-group">
							<label class="textbold text20" style="color: #000 !important;">for Year</label>
			...
			<script src="<?php echo base_url('assets/chartjs') ?>/js/script_profit_revenue_cost_sales_FTE.js"></script>
			<script>   
			$(document).ready(function() {
			    ...
			    initialize(nodejs_api_helper.base_url +'/sales_revenue/1',  nodejs_api_helper, allChartsOnThePage, filterDiv, exportToPDFBtn, exportToExcelBtn, exportToPptsBtn); //for default year -- currently one

			    $("#btn_update_report").click(function() {
			        initialize(nodejs_api_helper.base_url +'/sales_revenue/'+ $("#financial_year").find(":selected").val(), nodejs_api_helper, allChartsOnThePage, filterDiv, exportToPDFBtn, exportToExcelBtn);
