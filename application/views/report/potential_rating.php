    ...
    <div class="row">
       <div class="col-sm-8">
        <ol class="breadcrumb">
            ...
            <li class="active">Potential Rating Distribution Report</li>
        </ol>
       </div>
...
<div class="container-fluid compp_fluid">
    <div class="text-center mt-4">
        ...
        ?>
        <h3 class="text20 textbold" style="margin-bottom:-8px">Potential Rating Distribution Report<strong class="total-emp"></strong>
    </div>
...
var GRAPHAPIURL="<?php echo base_url('api/graph/report/1/1/potential') ?>";
...
var displayName = {
    ...
    "perfRating": "<?php echo !empty($display_field_name_array['market_base_salary_level_7']) ? $display_field_name_array['market_base_salary_level_7'] : 'MBM Base-8'?>",
...
?>
<script src="<?php echo base_url('assets/chartjs') ?>/js/potential_rating.js"></script>
<script>
