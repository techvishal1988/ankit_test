...
<?php //echo '<pre />'; print_r($res['Level']) ?>
</div>
<?php echo @$msg ?>
<div id="graph"></div>
<style>
...
<script>
 function wrap(text, width) {
    ...
    dataset = [
        <?php foreach($res['Level'] as $k) { ?>
        {label:"<?php echo $k['Level'] ?>", "Minimum":<?php echo $k['Minimum'] ?>, "Average":<?php echo $k['avg'] ?>, "Maximum": <?php echo $k['Maximum'] ?>},
        <?php } ?>
