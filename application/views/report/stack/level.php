...
<body>
<div id="level" style="position: absolute; margin-top: -52px"></div>
...
var dataset = [
	<?php $str='';
	for($i=0;$i<count($res['Level']);$i++) { ?>
	{label:"<?php echo $res['Level'][$i]['Level'] ?>", "Minimum":<?php echo $res['Level'][$i]['Minimum'] ?>, "Maximum":<?php echo $res['Level'][$i]['Maximum'] ?>, "Average": <?php echo $res['Level'][$i]['avg'] ?>},
	<?php } ?>
