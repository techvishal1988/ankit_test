    ...
    <div class="row">
       <div class="col-sm-8">
        <ol class="breadcrumb">
            ...
            <li class="active">Successor's Readiness Level Report</li>
        </ol>
       </div>
...
<div class="container-fluid compp_fluid">
    <div class="text-center mt-4">
        ...
        ?>
        <h3 class="text20 textbold" style="margin-bottom:-8px">Successor's Readiness Level Report<strong class="total-emp"></strong>
    </div>
...
var GRAPHAPIURL = "<?php echo base_url('api/graph/report/1/1/successor-readyness') ?>";
var titlePrefix = 'Readiness Level Distribution by  ';
var dataKeys = {
    ...
    "readynessLevel": "<?php  echo !empty($datakey_array['readyness_level']) ? $datakey_array['readyness_level'] : 'readyness_level'; ?>",
...
var displayName = {
    ...
    "readynessLevel": "<?php  echo !empty($display_field_name_array['readyness_level']) ? $display_field_name_array['readyness_level'] : 'Readyness level' ?>",
...
?>
<script src="<?php echo base_url('assets/chartjs') ?>/js/successor_readyness_report.js"></script>
<script>
