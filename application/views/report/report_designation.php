      ...
      <div class="row">
        <div class="col-md-12">
          <div id="datafordownload">
            ...
            <hr />
            <?php if(!isset($msg)) {
        $array=['Minimum','avg','Maximum']; //echo '<pre />'; print_r($res['Level']) ?>
            <div class="table-responsive">
              <table class="table table-bordered">
                <thead>
                <th>#</th>
                  <?php foreach($res['DesignationTitle'] as $value)
                                { 
                                     //echo $value['Level'];
                                    echo '<th>'.$value['DesignationTitle'].'</th>';
                                }
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <?php   
                            $total=0;
                            foreach($res['DesignationTitle'] as $v)
                                { 
                                 $total+=$v[$val];
                                  ?>
