    ...
    <div class="row">
       <div class="col-sm-8">
        <ol class="breadcrumb">
            ...
            <li class="active">Promotion Cases Distribution Report</li>
        </ol>
       </div>
...
<div class="container-fluid compp_fluid">
    <div class="text-center mt-4">
        ...
        ?>
        <h3 class="text20 textbold" style="margin-bottom:-8px">Promotion Cases Distribution Report<strong class="total-emp"></strong>
    </div>
    ...
    <div class="row justify-content-center mt-3" id="chartNode">
        <div class="col-md-12">
            <div class="row mt-4">
                ...
                <div class="col-md-6 <?php $hide_field_array["start_date_for_role"] ?>">
                    <div class="card mb-4">
                        <div class="card-body">
                ...
                <div class="col-md-6 <?php print $hide_field_array["subfunction"] ?>">
                    <div class="card mb-4">
                        <div class="card-body">
                            <div id="subFunctionChart" class="w-100" style="height: 600px"></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 <?php print $hide_field_array["sub_subfunction"] ?>">
                    <div class="card mb-4">
                        <div class="card-body">
                            <div id="subSubFunctionChart" class="w-100" style="height: 600px"></div>
                        </div>
                    </div>
                </div>
            </div>
...
var GRAPHAPIURL="<?php echo base_url('api/graph/report/1/1/promotion') ?>";
    var titlePrefix = 'Promotion Distribution by  ';
...
var dataKeys = {
    ...
    "gender": "gen",
    "subFunction": "s_fun",
    "subSubFunction": "s_s_fun",
    "identifiedTalent": "cri_t",
    "criticalPositionHolder": "cri_p",
    "specialCategoryOne": "s_cat",
    "urbanRuralClassification": "urb_r_c",
    "promotedIn2yrs": "pr_2_y",
};
...
var displayName = {
    ...
    "startDate": "<?php echo !empty($display_field_name_array['company_joining_date']) ? $display_field_name_array['company_joining_date'] : 'Date of Joining';?>",
    ...
    "promotedIn2yrs": "<?php  echo !empty($display_field_name_array['promoted_in_2_yrs']) ? $display_field_name_array['promoted_in_2_yrs'] : 'Promoted in 2 yrs' ?>",
...
?>
<script src="<?php echo base_url('assets/chartjs') ?>/js/promotion_cases_distribution_report.js"></script>
<script>
